...
export const CLEAN: Record<string, string> = {
  ...
  'docs/_plans/MINIAPP-337-meetings.md': [
    '# MINIAPP-337 — meetings',
    '',
    '**Status:** active',
    '**Branch:** miniapp-337_meetings',
    '',
    '### Decision: the row is the tick',
    '',
...
export const BRANCHES = ['main', 'miniapp-337_meetings'];
