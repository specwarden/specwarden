...
```bash
pnpm add -D specwarden @specwarden/speckit
```
...
- [GUIDE.md](https://github.com/specwarden/specwarden/blob/main/modules/speckit/GUIDE.md) — how to use it, from the install to a green run
