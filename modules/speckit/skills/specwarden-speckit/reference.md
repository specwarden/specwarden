<!-- GENERATED from modules/speckit/GUIDE.md. Edit the guide. -->
...
nothing — see [the OpenSpec guide](https://github.com/specwarden/specwarden/blob/main/modules/openspec/GUIDE.md) for what the seam is for, which
is identical.
