...
▸ **module** — Documentation checks: paths, symbols, counts, placement, hygiene.
...
```bash
pnpm add -D specwarden @specwarden/docs
```
...
- [GUIDE.md](https://github.com/specwarden/specwarden/blob/main/modules/docs/GUIDE.md) — how to use it, from the install to a green run
