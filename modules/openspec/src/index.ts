 ...
 * else's tool cannot be a mandatory part of a quality gate: a repository that has
 ...
 */
export { DEFAULT_REQUIREMENT_PATTERN, openspec } from './openspec/openspec.source';
