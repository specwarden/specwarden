...
export type { ISpecwardenConfig, TSharedBuildInput } from './config/config.model';
...
// The perimeter's pure core, public so a consumer can test ITS OWN policies along the
...
// self-checks assembled from defaults. The reason a config can be short.
export { discoverChecks, CheckDiscoveryError, selfChecks, SELF_CHECK_IDS, loadConsumerTree } from './consumer-tree';
export type { IDiscoveredChecks, ISelfCheckOptions, ISelfCheckInputs, ILoadedTree } from './consumer-tree';
