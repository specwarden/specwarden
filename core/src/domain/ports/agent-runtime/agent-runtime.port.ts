 ...
 * and treats every other code as a non-blocking hook error, which is a decision Claude made,
 ...
 *
 * A consumer running its own model implements this against its own hook format and
