...
export const rules = [
  ...
  // { id: 'doc-symbols', statement: 'Documentation names only symbols the code still declares.', owner: '.specwarden/checks/docs/doc-symbols.check.mjs', enforcement: { enforcedBy: ['doc-symbols'] } },
