...
export const rules = [
  ...
  // { id: 'doc-counts', statement: 'A count in prose is re-derived from the repository, not restated.', owner: '.specwarden/checks/docs/doc-counts.check.mjs', enforcement: { enforcedBy: ['doc-counts'] } },
  // { id: 'doc-placement', statement: 'Every document sits where the placement contract puts its kind.', owner: '.specwarden/checks/docs/doc-placement.check.mjs', enforcement: { enforcedBy: ['doc-placement'] } },
