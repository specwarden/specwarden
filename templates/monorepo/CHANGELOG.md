...
- Updated dependencies [33bc7fb]
  - specwarden@0.2.0
  - @specwarden/docs@0.2.0
  - @specwarden/ops@0.2.0
  - @specwarden/security@0.2.0
  - @specwarden/scaffold-parts@0.2.0

## 0.1.0

### Minor Changes

- The first public release. A pnpm workspace — lockfile, credential scan, documentation paths; build order, dependency pins and CI coverage as examples.
