...
export { ciCoverageExamplePart } from './ci-coverage/ci-coverage.part';
export { shellScopePart } from './shell-scope/shell-scope.part';
export { envPairingExamplePart } from './env-pairing/env-pairing.part';
export { proxyUpstreamsExamplePart } from './proxy-upstreams/proxy-upstreams.part';
...
export { agentDefinitionsPart } from './agent-definitions/agent-definitions.part';
export type { IAgentDefinitionsOptions } from './agent-definitions/agent-definitions.part';
