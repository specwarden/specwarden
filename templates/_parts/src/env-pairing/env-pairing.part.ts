 ...
 */
export const envPairingExamplePart = (ctx: ITemplateContext): IPart => {
...
`;
  return {
    files: [
      {
        path: 'checks/ops/env-pairing.check.mjs.example',
        body: `${header(
...
`,
    ...
    rules: [exampleRule('env-pairing', 'Every key a service reads is set for every mode it runs in.')],
  };
};
